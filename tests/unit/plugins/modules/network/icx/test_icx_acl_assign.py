...
class TestICXAclAssignModule(TestICXModule):
    ...
    def test_icx_acl_assign_invalid_arg_ipv6_access_group(self):
        ...
        set_module_args(dict(ipv6_access_group=dict(acl_name='123', in_out='in', ethernet='1/1/2', lag='25', vlan=dict(vlan_num='555', interfaces=['ethernet 1/1/2']), logging='enable')))
        result = self.execute_module(failed=True)
