...
class TestICXAaaAuthenticationModule(TestICXModule):
    ...
    def test_icx_aaa_authentication_all_options_remove(self):
        ...
        set_module_args(dict(dot1x=dict(primary_method='radius',backup_method1='none',state='absent'),
                             ...
                             snmp_server=dict(primary_method='enable',backup_method_list=['line','local','radius','tacacs','tacacs+','none'],state='absent'),
                             web_server=dict(primary_method='enable',backup_method_list=['line','local','radius','tacacs','tacacs+','none'],state='absent')))
    ...
    def test_icx_aaa_authentication_dot1x_enable(self):
        ...
        set_module_args(dict(dot1x=dict(primary_method='radius',state='present'),enable=dict(primary_method='enable',backup_method_list=['line','local'],state='present')))
