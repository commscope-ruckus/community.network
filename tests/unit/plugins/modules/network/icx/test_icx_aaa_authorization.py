...
from ansible_collections.community.network.plugins.modules.network.icx import icx_aaa_authorization
...
class TestICXAaaAuthorizationModule(TestICXModule):
    ...
    def setUp(self):
        ...
        self.mock_load_config = patch('ansible_collections.community.network.plugins.modules.network.icx.icx_aaa_authorization.load_config')
        self.load_config = self.mock_load_config.start()
        self.mock_exec_command = patch('ansible_collections.community.network.plugins.modules.network.icx.icx_aaa_authorization.exec_command')
